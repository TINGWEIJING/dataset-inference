...
class AbsArgs:
    '''
    Abstract class for args variable for type annotation
    '''
    dataset: str
    model_id: str
    batch_size: int
    imagenet_architecture: str
    feature_type: str
    mode: str
    normalize: bool
    ...
    file_dir: str  # generated
    device: torch.device  # generated
    num_classes: int  # generated
    distance: str  # generated
...
def parse_args():
    ...
    parser.add_argument("--dataset",
                        ...
                        type=str,
                        default="CIFAR10",
                        choices=["ImageNet", "MNIST", "SVHN", "CIFAR10", "CIFAR100", "AFAD"])
    parser.add_argument("--model_type",
                        help="cnn/wrn-40-2/wrn-28-10/preactresnet/resnet34",
                        type=str,
                        default="wrn-28-10",
    ...
    parser.add_argument("--batch_size",
                        help="Batch Size for Train Set (Default = 100)",
                        type=int,
                        default=100)
    ...
    parser.add_argument("--dropRate",
                        help="DropRate for Teacher model",
                        type=float,
                        default=0.0)
    parser.add_argument("--imagenet_architecture",
                        help="Imagenet Architecture",
                        type=str,
                        default="wrn",
    ...
    parser.add_argument("--pseudo_labels",
                        help="Use alternate dataset",
                        type=int,
                        default=0,
                        choices=[0, 1])
    parser.add_argument("--reverse_train_test",
                        help="Use alternate dataset",
                        type=int,
                        default=0,
                        choices=[0, 1])
    ...
    parser.add_argument("--concat",
                        help="For Overlap Exps",
                        type=int,
                        default=0,
                        choices=[0, 1])
    parser.add_argument("--concat_factor",
                        help="For Overlap Exps",
                        type=float,
                        default=1.0)
    ...
    parser.add_argument("--resume",
                        help="For Resuming from checkpoint",
                        type=int,
                        default=0)
